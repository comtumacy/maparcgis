<template>
    <div class="adminLeftUserSearch">
      <i>请输入搜索内容</i>
      <el-form :inline="true" :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-form-inline">
        <el-form-item label="查找内容：" prop="content">
          <el-input v-model="ruleForm.content" placeholder="请输入用户名、电话号码或备注进行搜索"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button class="button1" type="primary" v-on:click="onSubmit('ruleForm')">查询</el-button>
